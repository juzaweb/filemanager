                ...
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-3 col-lg-3 m-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li><a href="javascript:rename('{{ $item->id }}', '{{ $item->name }}', {{ $item->is_file == 1 ? 1 : 0 }})" class="dropdown-item"><i class="fa fa-edit fa-fw"></i> {{ trans('filemanager::file-manager.menu-rename') }}</a></li>

                      @if($item->is_file)
                            <li><a href="javascript:download('{{ $item->id }}')" class="dropdown-item"><i class="fa fa-download fa-fw"></i> {{ trans('filemanager::file-manager.menu-download') }}</a></li>

                            <li class="divider"></li>

                        @if($item->thumb)
                              <li><a href="javascript:fileView('{{ $item->url }}', '{{ $item->updated }}')" class="dropdown-item"><i class="fa fa-image fa-fw"></i> {{ trans('filemanager::file-manager.menu-view') }}</a></li>
                      ...
                      <li><a href="javascript:trash('{{ $item->id }}', {{ $item->is_file ? 1 : 0 }})" class="dropdown-item"><i class="fa fa-trash
